...
const Login = () => {
    const { showAlert, loading, setLoading, logInbyEmailAndPassword, loginBySocailAccounts } = useContext(AuthContext);
    ...
    return (
        <div className="mx-auto md:max-w-2xl max-w-7xl flex flex-col p-6 rounded-md sm:p-10 dark:bg-gray-900 dark:text-gray-100 bg-gray-100 shadow shadow-slate-500 border-slate-700">
            ...
            <form onSubmit={(e) => handleLogin(e)}
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} required type="email" name="email" id="email" placeholder="Login Email" className="w-full text-xl px-3 py-3 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100" />
                    </div>
                    <div className="mt-4">
                        ...
                        <div className='relative'>
                            <input required type={!showPassword ? "password" : "text"} name='password' className="block w-full px-4 py-3 mt-2  bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" onChange={(e) => { setPassword(e.target.value) }} placeholder="* * * * * * * *" />
