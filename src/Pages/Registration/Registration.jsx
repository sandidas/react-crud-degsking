...
const Registration = () => {
    ...
    // counter to redirect after 5 for logged in user
    useEffect(() => {
        let seconds = 0;
    ...
    if (user && user?.uid) {
        return (
            <div className='flex flex-col space-y-4 items-center justify-center h-[60vh]'>
                ...
                <div className='text-7xl animate-pulse font-bold text-gray-700'> {count}</div>
            </div>
        )
    } else {

        return (
            <div className='grid grid-cols-1 xl:grid-cols-2 gap-4  max-w-7xl place-content-center  min-h-[90vh] mx-auto'>
