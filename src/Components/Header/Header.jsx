        ...
        <aside className="h-full py-3 w-80 absolute right-0 top-14 z-10" onClick={() => setUSettings(!uSettings)}>
            <div className="divide-y divide-gray-700 dark:bg-gray-900 dark:text-gray-100 bg-gray-100 shadow-md">
                <ul className="pt-2 pb-4 space-y-2 text-sm">
                    ...
                    <li>
                        <Link rel="noopener noreferrer" to="/" className="flex items-center pl-8 py-3 space-x-3  w-full hover:bg-gray-200 dark:hover:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
                    ...
                    <li>
                        <a rel="noopener noreferrer" to="/" className="flex items-center pl-8 py-3 space-x-3  w-full hover:bg-gray-200 dark:hover:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
